...
import { collectJarNS } from "./deps.js";
import { parsePkgJson } from "./parsers-js.js";
import { applyPurl } from "./purl.js";
  ...
  for (const gradleArg of gradleArgs) {
    ...
    if (result.status !== 0 || result.error) {
      ...
      if (result.stderr) {
        ...
        console.log(
          "2. Try running cdxgen with the custom JDK11-based image `ghcr.io/cyclonedx/cdxgen-java11:v13`.",
        );
