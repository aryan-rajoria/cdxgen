...
// common-ancestor-path v2 dropped its default export in favour of a named one.
import { commonAncestorPath as ancestorPath } from "common-ancestor-path";
...
// See tracker.js: `any` return keeps TS 7 declaration emit happy (TS4094) for
// this mixin factory over an anonymous class with private (#) fields.
/** @returns {any} */
