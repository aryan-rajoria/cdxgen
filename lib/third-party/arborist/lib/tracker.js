...
// This mixin factory returns an anonymous class with private (#) fields, which
// TypeScript 7's declaration emitter rejects (TS4094). The emitted declaration
// was already all-`any` under TS 6, so annotating the return as `any` keeps the
// generated types equivalent while allowing a clean declaration emit.
/** @returns {any} */
const Tracker = (cls) =>
