...
class OverrideSet {
  ...
  *ancestry() {
  ...
  static findSpecificOverrideSet(first, second) {
    ...
    if (OverrideSet.haveConflictingRules(first, second)) {
    ...
    return OverrideSet.findCommonAncestor(first, second);
  }
  ...
  static doOverrideSetsConflict(first, second) {
    ...
    const specificSet = OverrideSet.findSpecificOverrideSet(first, second);
    ...
    return OverrideSet.haveConflictingRules(first, second);
  }
  ...
  static haveConflictingRules(first, second) {
    ...
    for (const [key, firstRule] of firstRules) {
      ...
      try {
        ...
        if (
          (firstSpec.type === "range" || firstSpec.type === "version") &&
