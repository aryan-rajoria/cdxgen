 ...
 *
 * `utils.js` declares nothing of its own. It re-exports the 261 public names that
 * used to live here so existing imports keep working for one major version. Each
 * implementation, and its JSDoc, now lives in the leaf module it was moved to
 * (`purl.js`, `spdx.js`, `deps.js`, `ecosystems.js`, `parsers-*.js`, `core-*.js`,
 * `state.js`, `paths.js`).
 *
 * New code should import from the specific module instead. See MIGRATING-TO-V13.md.
 */
import {
...
import { CDXGEN_VERSION, frameworksList } from "../core/state.js";
import {
  executeAtom,
  findAppModules,
  getAtomCommand,
} from "../inventory/atomUtils.js";
import { getDefaultBomAuditCategories } from "../inventory/auditCategories.js";
import {
  collectJarNS,
...
import { isPartialTree, recomputeScope } from "../inventory/depsUtils.js";
import {
...
export { getCppModules } from "./cppEvidence.js";
export { addEvidenceForImports } from "./jsEvidence.js";
...
import { getMavenCommand, getMillCommand } from "./gradleutils.js";
