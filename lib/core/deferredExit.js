 ...
 *
 * @type {Array<{ecosystem: string, tool: string, detail: string, exitCode: number|undefined, command: string|undefined, outputExcerpt: string|undefined}>}
 */
...
export function deferFailOnError(options, failure) {
  ...
  const entry = {
    ...
    outputExcerpt: failure?.outputExcerpt,
  };
