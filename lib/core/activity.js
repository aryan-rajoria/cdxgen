...
const LOCKFILE_ACTIVITY_HINTS = new Map([
  ...
  [
    ".terraform.lock.hcl",
    {
      classification: "lockfile",
      ecosystem: "terraform",
      label: "Terraform provider lockfile",
    },
  ],
  [
    "uv.lock",
...
const MANIFEST_ACTIVITY_HINTS = new Map([
  ...
  [
    "cpanfile",
    { classification: "manifest", ecosystem: "cpan", label: "CPAN manifest" },
  ],
  [
    "project.toml",
    {
