 ...
 * document, so the dependency graph is left intact. Requires
 * `--include-formulation`: without it there is no formulation section to move
 * them into, and they stay in `components[]` carrying `isExternal`.
 *
 * @param {Object} bomJson BOM JSON object
 * @param {Object} options CLI options
 *
