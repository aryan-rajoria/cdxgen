...
import { hasAnyProjectType } from "../../helpers/core-misc-b.js";
...
import { enhanceBom } from "../../helpers/licenseEnhancer.js";
...
export function filterBom(bomJson, options) {
  ...
  for (const comp of bomJson.components) {
    ...
    if (options?.technique?.length && !options.technique.includes("auto")) {
      ...
      if (
        usedTechniques &&
        Set.intersection(usedTechniques, allowedTechniques).size === 0
      ) {
        filtered = true;
        continue;
      }
