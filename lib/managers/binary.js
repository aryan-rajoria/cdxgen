...
import { isCycloneDxComponentTypeEnabled } from "../ecosystems/bomUtils.js";
import { createContainerRiskProperties } from "../ecosystems/containerRisk.js";
import {
  attachIdentityTools,
  extractToolRefs,
} from "../ecosystems/evidenceUtils.js";
import { createGtfoBinsProperties } from "../ecosystems/gtfobins.js";
import { OS_DISTRO_ALIAS, readOsRelease } from "../ecosystems/osinfo.js";
import {
  collectExecutables,
  collectSharedLibs,
} from "../ecosystems/osPackageResolver.js";
import {
  resolveCdxgenPlugins,
  resolvePluginBinary,
  setPluginsPathEnv,
} from "../ecosystems/plugins.js";
import { tryBuildPurl } from "../ecosystems/purl.js";
import {
  adjustLicenseInformation,
  findLicenseId,
  isSpdxLicenseExpression,
} from "../ecosystems/spdx.js";
