...
async function loadDockerModule({
  ...
  const dockerModule = await esmock("./docker.js", {
    ...
    "../ecosystems/envcontext.js": utilsStub,
    "../ecosystems/evidenceUtils.js": utilsStub,
    "../ecosystems/osPackageResolver.js": utilsStub,
    "../ecosystems/depsUtils.js": utilsStub,
    "../ecosystems/osqueryTransform.js": utilsStub,
  });
  return {
