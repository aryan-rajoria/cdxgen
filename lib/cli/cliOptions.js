...
import { isSecureMode } from "../core/activity.js";
import {
  DEFAULT_CDX_SPEC_VERSION,
  normalizeCycloneDxComponentTypeFilter,
} from "../ecosystems/bomUtils.js";
import { isHbomOnlyProjectTypes } from "../ecosystems/hbom.js";
...
export function buildInitialOptions(args, { filePath, isRemoteOrPurl }) {
  const res = Object.assign({}, args, {
    ...
    licenseEnhance: process.env.CDXGEN_LICENSE_ENHANCE !== "false",
    licenseEnrich: process.env.CDXGEN_LICENSE_ENRICH !== "false",
    licensePolicy: args.licensePolicy || process.env.CDXGEN_LICENSE_POLICY,
    licenseRef:
      args.licenseRef === true || process.env.CDXGEN_LICENSE_REF === "true",
  });
