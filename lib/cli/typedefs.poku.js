...
//
// The completeness check only holds immediately after `pnpm gen-types`, which
// maintainers run by hand as part of a release. Adding a source file would
// otherwise fail the suite for everyone until the types/ tree is regenerated,
// so that check runs only when CDXGEN_VERIFY_TYPES is set.
