...
import { resolvePluginBinary } from "../ecosystems/plugins.js";
import { readBinary } from "../ecosystems/protobom.js";
import {
  ...
  if (process.platform !== "win32") {
    describe("HBOM support", () => {
      it("delegates hbom project types to the hbom helper", async () => {
        const actualHbomHelpers = await import("../ecosystems/hbom.js");
