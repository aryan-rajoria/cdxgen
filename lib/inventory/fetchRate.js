...
const HOST_POLICIES = [
  ...
  // table instead of the CDN default. Like crates.io, the row is JS-only —
  // rate.rs has no entry for the host, so the requests are kept off the Rust
  // transport to leave one gate in charge.
  {
