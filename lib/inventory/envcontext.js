...
export function installRubyVersion(rubyVersion, filePath) {
  ...
  if (rubyVersion.startsWith("1.")) {
    ...
    console.log(
      `Installing Ruby version ${rubyVersion} requires specific development libraries. Consider using the custom container image "ghcr.io/cyclonedx/cdxgen-debian-ruby26:v13" instead.`,
    );
    console.log("The below install step is likely to fail.");
  }
  console.log(
