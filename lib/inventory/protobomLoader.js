// Kept local (not imported from `@cdxgen/cdx-proto/node`) because this module
// gates whether the optional protobuf dependency is loaded at all. The
// authoritative list is `protoBomFileExtensions` in `@cdxgen/cdx-proto/node`;
