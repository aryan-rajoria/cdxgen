...
} from "../ecosystems/atomUtils.js";
import {
  collectDosaiCryptoComponents,
  findCryptoAlgos,
} from "../ecosystems/cbomutils.js";
import { collectMvnDependencies } from "../ecosystems/deps.js";
import { mergeServices } from "../ecosystems/depsUtils.js";
import {
...
import { parseOccurrenceEvidenceLocation } from "../ecosystems/evidenceUtils.js";
import {
  analyzeGolemProject,
...
export function createEvinseFile(sliceArtefacts, options) {
  ...
  bomJson.annotations = [];
  appendComponentProperties(bomJson.metadata?.component, metadataProperties);
  ...
  const bomNSData = postProcess({ bomJson }, { ...options, executeOsQuery });
  safeWriteSync(
    evinseOutFile,
