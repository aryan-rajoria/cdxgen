 ...
 */
export declare function getStructure(filePath: string): undefined | Object;
/**
 ...
 */
export declare function extractCompilerParamsFromBuild(buildOutput: string): Object;
/**
 ...
 */
export declare function index(filePath: string, compilerArgs: string | Array<string>): undefined | Object;
/**
 ...
 */
export declare function moduleInfo(moduleName: string, compilerArgs: string | Array<string>): undefined | Object;
/**
 ...
 */
export declare function collectBuildSymbols(basePath: string, options: Object): Object;
/**
