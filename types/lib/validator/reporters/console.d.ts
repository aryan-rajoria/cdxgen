 ...
 * @returns {string}
 */
export declare function formatFindings(findings: Array<object>, options?: object): string;
/**
 ...
 * @returns {string}
 */
export declare function formatBenchmarks(reports: Array<object>): string;
/**
 ...
 * @returns {string}
 */
export declare function formatSummary(summary: object): string;
/**
 ...
 * @returns {string}
 */
export declare function render(report: object): string;
