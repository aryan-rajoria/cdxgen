 ...
 */
export declare function getComponentPropertyValue(component: object, propertyName: string): string | undefined;
/**
 ...
 * @returns {string | undefined} Property value if present
 */
export declare function getPropertyValue(properties: object[], propertyName: string): string | undefined;
/**
 ...
 */
export declare function hasAnyPropertyValue(properties: object[], propertyNames: string[]): boolean;
/**
 ...
 */
export declare function hasTrustedPublishingProperties(properties: object[]): boolean;
/**
 ...
 */
export declare function hasRegistryProvenanceEvidenceProperties(properties: object[]): boolean;
/**
 ...
 * @returns {boolean} True when trusted publishing is recorded for npm, PyPI, or Cargo
 */
export declare function hasComponentTrustedPublishing(component: object): boolean;
/**
 ...
 */
export declare function hasComponentRegistryProvenanceEvidence(component: object): boolean;
/**
 ...
 */
export declare function hasComponentRegistryProvenance(component: object): boolean;
/**
 ...
 */
export declare function getTrustedComponents(components: object[]): object[];
/**
 ...
 */
export declare function getProvenanceComponents(components: object[]): object[];
/**
 ...
 */
export declare function getTrustedPublishingComponentCounts(components: object[]): {
    cargo: number;
    npm: number;
    pypi: number;
    total: number;
