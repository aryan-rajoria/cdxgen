 ...
 */
export declare function parseGitmodules(text: string): {
    name: string;
    path?: string;
    url?: string;
    branch?: string;
 ...
 */
export declare function resolveSubmoduleUrl(submoduleUrl: string, originUrl: string): string | null;
/**
 ...
 */
export declare function submodulePurlCoordinates(resolvedUrl: string, version?: string): {
    type: string;
...
//# sourceMappingURL=gitmodules.d.ts.map