 ...
 */
export declare function parseHuggingFaceReadmeFrontmatter(raw: string): object | undefined;
/**
 ...
 */
export declare function hasHuggingFaceCardSignals(cardData: object | undefined): boolean;
/**
 ...
 */
export declare function repoIdFromFixtureDirectory(filePath: string): string | undefined;
/**
 ...
 */
export declare function createHuggingFaceComponentReference(modelRef: string, _options?: {}): {
    "bom-ref": string;
    group: string;
    name: string;
    purl?: string;
 ...
 */
export declare function createHuggingFaceDatasetReference(dataset: object | string, options?: {
 ...
 */
export declare function createHuggingFaceModelCard(cardData?: object, config?: object, addDatasetReference?: (dataset: object | string) => object | undefined, options?: {
    urlSanitizer?: (url: string | undefined) => string | undefined;
}): object | undefined;
/**
 ...
 */
export declare function createHuggingFacePedigree(cardData?: object, adapterConfig?: object, quantization: string | undefined, options?: {
    createPedigreeModelReference?: (modelRef: string) => object | undefined;
}): object | undefined;
