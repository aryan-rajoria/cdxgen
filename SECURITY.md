...
| **Container hardening**            | Providing secure container images                                                                  | `ghcr.io/cdxgen/cdxgen-secure` with Node.js permissions, non-root user (`cyclonedx`), restricted filesystem access, `CDXGEN_IN_CONTAINER=true` detection                                                                               |
