...
| dynamic SBOM (tracebom)      | covered         | `TRACEBOM.md`, `LESSON16.md`, `LESSON34.md`                          | standalone dynamic SBOM binary tracing runtime libraries and HTTP services under a sandbox                    |
