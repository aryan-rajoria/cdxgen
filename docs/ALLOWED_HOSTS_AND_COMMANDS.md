...
| **Rust**                       | `rust`, `rust-lang`, `cargo`                                                                                                                                     | `cargo`                                                                             | `crates.io` (only for crates the local Cargo registry cannot account for)                                    |
...
| **Container**                  | `oci`, `docker`, `podman`, `container`, `rootfs`, `oci-dir`                                                                                                      | `docker`, `podman` _(not required for local `rootfs` / `oci-dir` directory inputs)_ | `docker.io`, `api.nuget.org`, `*.maven.org` _(not required for local `rootfs` / `oci-dir` directory inputs)_ |
