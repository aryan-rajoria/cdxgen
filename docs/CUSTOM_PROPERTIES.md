...
| `cdx:cargo:hostOnly`                      | component             | boolean string                  | `"true"`                                                                   | When the crate is a build dependency or a proc-macro                                                                                              | Separates crates compiled for the build host from those linked into the shipped artifact                                                                                                                                                                                                              | Warning / triage |
