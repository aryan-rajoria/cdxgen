...
| `cdx:zig:*`                                                                                | Zig (`build.zig.zon`)                                                               | Fetch URL, content hash, local path dependencies, minimum toolchain version                                                                                                                                  | Detect unpinned or locally-sourced dependencies, verify content-addressed fetches, enforce a minimum toolchain baseline                                                                                                        | [Package manager and language ecosystems](#inventory-packages)       | [4](#example-4)                  |
...
- **Zig:** `cdx:zig:hash`, `cdx:zig:local`, `cdx:zig:minimum_zig_version`, `cdx:zig:path`, `cdx:zig:url`, `cdx:zig:version`
...
- **C/C++ (CMake):** `cdx:cmake:depKind`, `cdx:cmake:resolvedVia`, `cdx:cmake:sourceDir`, `cdx:cmake:uninitialised`
