...
| `cdx:cargo:linkage`                       | component             | enum string                     | `static`, `dynamic`                                                        | On a native library component, from the vendoring features the resolver enabled                                                                   | `static` means the library ships inside the artifact and its advisories and license obligations travel with it; `dynamic` means the deployment environment must provide and patch it                                                                                                                   | Hard deny        |
