...
In case of the Ruby application, usage of the container image `ghcr.io/cyclonedx/cdxgen-debian-ruby33:v13` is recommended.

```shell
git clone https://github.com/bionomia/bionomia
docker run --rm -v /tmp:/tmp -v $(pwd):/app:rw -t ghcr.io/cyclonedx/cdxgen-debian-ruby33:v13 -r /app -o /app/bom.json -t ruby --profile research
```
