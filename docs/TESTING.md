...
Unit tests cover functions; the golden harness covers whole-BOM output. Three
layers make a BOM comparable between runs.

### Normalization (`contrib/sbom-normalize.js`)
...
### Differential v12-vs-v13 (`ci/diff-v12-v13.js`)
